...
double nVegies = double.Parse(Console.ReadLine());
double mFruits = double.Parse(Console.ReadLine());
int kgVegies = int.Parse(Console.ReadLine());
int kgFruits = int.Parse(Console.ReadLine());

// Calculations

double price = ((nVegies * kgVegies) + (mFruits * kgFruits)) / 1.94;
